...
class App:
    def __init__(self):
        ...
        # self.invisble_label = customtkinter.CTkLabel(self.entry_pack, text="0", text_font=("Arial", 26), width=0, height=0, text_color='#323232')
        # self.invisble_label.pack(side=RIGHT, anchor='e')
        ...
        self.second_pack = customtkinter.CTkFrame(self.root, fg_color='#282828')
        self.second_pack.pack(side=LEFT, anchor="ne", padx=(15, 0), pady=(5, 0))


        #########################################
        # button frame
        self.second_set_cals_frame = customtkinter.CTkFrame(self.second_pack, fg_color='#282828')
        self.second_set_cals_frame.pack(side=TOP, anchor='e', padx=(35, 0))


        # key press pi button button 
        self.btn_pi = tkinter.Button(self.second_set_cals_frame, text="π", width=4, font=("Arial", 16), bg="#404040", fg="white", relief='flat') # command=self.c_key2
        self.btn_pi.grid(row=0, column=0, sticky="w", padx=2, pady=2)
        # simple fg and bg change when hovered over.
        self.btn_pi.bind('<Enter>', lambda e: self.btn_pi.config(fg='black', bg='#4D4D4D'))
        self.btn_pi.bind('<Leave>', lambda e: self.btn_pi.config(fg='white', bg='#404040'))
        # keyboard press events **
        
        
        # key press square root button 
        self.btn_sqro = tkinter.Button(self.second_set_cals_frame, text="√", width=4, font=("Arial", 16), bg="#404040", fg="white", relief='flat') # command=self.c_key2
        self.btn_sqro.grid(row=0, column=1, sticky="w", padx=2, pady=2)
        # simple fg and bg change when hovered over.
        ...
        # key press exp button 
        self.btn_exp = tkinter.Button(self.second_set_cals_frame, text="exp", width=4, font=("Arial", 16), bg="#404040", fg="white", relief='flat') # command=self.c_key2
        self.btn_exp.grid(row=0, column=2, sticky="w", padx=2, pady=2)
        # simple fg and bg change when hovered over.
        ...
        # key press mod button 
        self.btn_mod = tkinter.Button(self.second_set_cals_frame, text="mod", width=4, font=("Arial", 16), bg="#404040", fg="white", relief='flat') # command=self.c_key2
        self.btn_mod.grid(row=0, column=3, sticky="w", padx=2, pady=2)
        # simple fg and bg change when hovered over.
